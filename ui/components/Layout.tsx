...
import { IconChevronDown, IconChevronRight, IconRefresh, IconTextPlus } from "@tabler/icons-react";
...
export default function Layout() {
  ...
  return (
    <>
      <Changelog open={changelogOpened} onClose={closeChangelog} />
      <AppShell
        header={{ height: 60 }}
        navbar={{
          width: 250,
        ...
        <AppShell.Navbar p="sm">
          <ScrollArea type="never">
                          ...
                          .map((subroute) => {
                            ...
                            return (
                              <NavLink
                                ...
                                disabled={subroute.navbarProperties?.isDisabled?.(
                                  currentLeagueData
                                )}
                              />
                            );
            ...
            <NavLink
              ...
              leftSection={<IconTextPlus size={20} stroke={2} />}
              variant="light"
              disabled={loadingData}
              onClick={openChangelog}
            />
